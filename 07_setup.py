...
def game_over():
    ...
    msg_over_rect = msg_over.get_rect(center=((screen_width / 2), (screen_height / 2) - 60))
    msg_level_rect = msg_level.get_rect(center=((screen_width / 2), (screen_height / 2) + 60))
